...
public class SpinnerAdapter extends BaseAdapter{
    ...
    public SpinnerAdapter(Context context, ArrayList<StoreItem> store_item) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        /*StoreActivity.spinner_search.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        /*store_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StoreActivity.spinner_search.performClick();
                StoreActivity.spinner_search.setVisibility(View.GONE);
