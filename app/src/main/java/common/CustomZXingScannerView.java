...
public class CustomZXingScannerView extends View implements IViewFinder {
    ...
    private static final float LANDSCAPE_WIDTH_HEIGHT_RATIO = 0.75f;
    ...
    private final int mDefaultLaserColor = getResources().getColor(R.color.white);
    private final int mDefaultMaskColor = getResources().getColor(R.color.viewfinder_mask);
    private final int mDefaultBorderColor = getResources().getColor(R.color.white);
